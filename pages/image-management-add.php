...
if (isset($_POST['woo_form_submit']) && $_POST['woo_form_submit'] == 'yes')
{
	...
	$form['woo_path'] = isset($_POST['woo_path']) ? esc_url_raw($_POST['woo_path']) : '';
	if ($form['woo_path'] == '')
	{
	...
	$form['woo_link'] = isset($_POST['woo_link']) ? esc_url_raw($_POST['woo_link']) : '';
	if ($form['woo_link'] == '')
	{
	...
	$form['woo_target'] = isset($_POST['woo_target']) ? sanitize_text_field($_POST['woo_target']) : '';
	if($form['woo_target']!= "_blank" && $form['woo_target'] != "_parent" && $form['woo_target'] != "_self" && $form['woo_target'] != "_new")
	{
		$form['woo_target'] = "_blank";
	}
	
	$form['woo_title'] = isset($_POST['woo_title']) ? sanitize_text_field($_POST['woo_title']) : '';
	
	$form['woo_order'] = isset($_POST['woo_order']) ? intval($_POST['woo_order']) : '';
	
	$form['woo_status'] = isset($_POST['woo_status']) ? sanitize_text_field($_POST['woo_status']) : '';
	if($form['woo_status'] != "YES" && $form['woo_status'] != "NO")
	{
		$form['woo_status'] = "YES";
	}
	
	$form['woo_type'] = isset($_POST['woo_type']) ? sanitize_text_field($_POST['woo_type']) : '';
